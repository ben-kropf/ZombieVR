...
public class HelicopterController : MonoBehaviour
{
    ...
    float forward_Rotor_Torque_Multiplier = 0.5f;   // multiplier for control input
    float sideways_Rotor_Torque_Multiplier = 0.5f;  // multiplier for control input
    ...
    public Renderer rotatorTextureGO1;
    public Renderer rotatorTextureGO2;
    public Renderer bladesTextureGO;
    public float alpha;
    ...
    void Update()
    {
        ...
        bladesTextureGO.material.color = new Color(1.0f, 1.0f, 1.0f, 1.2f - alpha);
